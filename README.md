...
4. Всё делал по лекци, но проблемы всё же были:
 ...
 ![Скриншот](https://github.com/Lexacbr/gitlab/blob/main/screenshots/snap.png) 
  ...
  Тут я запутался в машинах, что на какой установленно, и понял потом, что на ВМ вообще не установлен Докер. Установил. Но проблемма не исчезла , т.к. устанавливал "руками" и не обратил внимание на Вагрант-файл, где было нужно произвести некоторые, важные настройки, а именно: нужно было создать на машине с Дженкинсом json файл с настройкой "insecure". Потом нужно рестортовать докер сервис
  ```bash
